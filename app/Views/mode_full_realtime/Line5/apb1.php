    ...
    const fetchDataRight1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart2(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L5_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L5_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
    ...
    const fetchDataLeft1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart2(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB1 - TEMP LEFT Actual', labels, valuesSet, 'L5_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L5_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            const filteredData = response.data.filter(item =>
                item.L5_HSM1_TYPE_BATTERY === "0" || item.L5_HSM1_TYPE_BATTERY === "1" || item.L5_HSM1_TYPE_BATTERY === "2"
            );
